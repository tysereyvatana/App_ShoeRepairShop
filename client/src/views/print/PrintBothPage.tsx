...
export function PrintBothPage() {
  const { id } = useParams();

  const { data, isLoading } = useQuery({
    queryKey: ["print-both", id],
    enabled: !!id,
  ...
  return (
    <Box>
      ...
      <Box className="thermal-paper">
        ...
        <Typography fontSize={13}>{receiverName}</Typography>
      ...
      {/* Small gap (cut line) */}
      <Box className="page-break" sx={{ height: 18 }} />
